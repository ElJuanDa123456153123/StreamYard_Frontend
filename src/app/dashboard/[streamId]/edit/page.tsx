...
import { Stream, StreamPrivacy, StreamPlatform } from '@/lib/types';
...
export default function EditStreamPage() {
  ...
  const loadStream = async () => {
    try {
      ...
      setFormData({
        ...
        privacy: stream.privacy || StreamPrivacy.PUBLIC,
        platform: stream.platform || [],
        maxParticipants: stream.maxParticipants || 10,
        ...
        scheduledFor: stream.scheduledFor ? new Date(stream.scheduledFor).toISOString().slice(0, 16) : '',
      });
    } catch (err: any) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await streamsService.update(streamId, dataToSend);
      ...
      if (Array.isArray(errorMessage)) {
        ...
        setError(errorMessage || 'Error al actualizar transmisión');
      }
    } finally {
      setLoading(false);
    }
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Editar Transmisión</h1>
              <p className="mt-1 text-gray-600">Actualiza la configuración de tu transmisión</p>
            </div>
          </div>
        </div>
